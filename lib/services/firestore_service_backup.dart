...
class FirestoreService {
  ...
  Future<bool> markItemUnavailable(String itemId) async {
    return updateItem(itemId, {'isAvailable': false});
  }
  ...
  Future<List<ItemModel>> searchItems(String query) async {
    try {
      ...
      // Filter items that contain the query in title or description
  ...
  /// Remove additional picture (placeholder implementation)
  Future<bool> removeAdditionalPicture(String uid, String pictureUrl) async {
    try {
      ...
      if (profile != null) {
        ...
        // TODO: Delete from Firebase Storage when implemented
